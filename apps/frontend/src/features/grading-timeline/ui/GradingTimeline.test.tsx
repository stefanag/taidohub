...
describe('<GradingTimeline>', () => {
  ...
  it('renders rows in rank-descending order (highest belt on top)', () => {
    const LOWER: BeltRank = { ...RANK, id: 'rank-kyu', sortOrder: 10, nameRomaji: 'Yonkyu' };
    const HIGHER: BeltRank = { ...RANK, id: 'rank-shodan', sortOrder: 100, nameRomaji: 'Shodan' };
    ...
    // Higher rank (Shodan, sortOrder 100) rendered first even though its date is older.
