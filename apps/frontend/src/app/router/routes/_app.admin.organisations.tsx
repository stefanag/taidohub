...
/**
 * Admin-only route mounting the organisations management page. Sits under
 * `_app` so the parent's session check still applies; this `beforeLoad`
 * layers a role check on top and redirects non-admins to `/dashboard`.
 */
